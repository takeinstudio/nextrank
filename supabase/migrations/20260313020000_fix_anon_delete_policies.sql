...
-- 9. Fix test_attempts.student_id FK: drop reference to auth.users, allow any UUID (custom auth)
...
-- 10. Fix test_attempts RLS: allow anon to insert/select using student_id directly (no auth.uid())
...
-- 12. question-images bucket for question diagrams
INSERT INTO storage.buckets (id, name, public)
